...
type Interface interface {
	...
	Rescan(*chainhash.Hash, []paytutil.Address, map[wire.OutPoint]paytutil.Address) error
	NotifyReceived([]paytutil.Address) error
	NotifyBlocks() error
...
type (
	...
	FilterBlocksRequest struct {
		...
		ExternalAddrs    map[waddrmgr.ScopedIndex]paytutil.Address
		InternalAddrs    map[waddrmgr.ScopedIndex]paytutil.Address
	...
	FilterBlocksResponse struct {
		...
		FoundOutPoints     map[wire.OutPoint]paytutil.Address
