...
var datadir = paytutil.AppDataDir("paytwallet", false)
...
func mainInt() int {
	...
	for !opts.Force {
		fmt.Print("Drop all paytwallet transaction history? [y/N] ")
	...
	fmt.Println("Dropping paytwallet transaction history")
