...
const (
	...
	defaultLogFilename      = "paytwallet.log"
...
type config struct {
	...
	TestNet1      bool                    `long:"testnet" description:"Use the test payt network (version 1) (default mainnet)"`
...
//
// The above results in paytwallet functioning properly without any config
