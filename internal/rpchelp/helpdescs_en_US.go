...
var helpDescsEnUS = map[string]string{
	...
	"getbalance--result0":    "The balance of 'account' valued in payt",
	"getbalance--result1":    "The balance of all accounts valued in payt",
	...
	"infowalletresult-relayfee":        "The minimum relay fee for non-free transactions in payt/KB",
	...
	"getreceivedbyaccount--result0":  "The total received amount valued in payt",
	...
	"getreceivedbyaddress--result0":  "The total received amount valued in payt",
	...
	"gettransactionresult-amount":          "The total amount this transaction credits to the wallet, valued in payt",
	...
	"listaccounts--result0--desc":  "JSON object with account names as keys and payt amounts as values",
	"listaccounts--result0--key":   "The account name",
	"listaccounts--result0--value": "The account balance valued in payt",
	...
	"listreceivedbyaccountresult-amount":        "Total amount received by payment addresses of the account valued in payt",
	...
	"listreceivedbyaddressresult-amount":            "Total amount received by the payment address valued in payt",
	...
	"listtransactionsresult-amount":             "The value of the transaction output valued in payt",
	...
	"listunspentresult-amount":        "The amount of the output valued in payt",
	...
	"sendfrom-amount":      "Amount to send to the payment address valued in payt",
	...
	"sendmany-amounts--desc":  "JSON object using payment addresses as keys and output amounts valued in payt to send to each address",
	"sendmany-amounts--key":   "Address to pay",
	"sendmany-amounts--value": "Amount to send to the payment address valued in payt",
	...
	"sendtoaddress-amount":    "Amount to send to the payment address valued in payt",
	...
	"settxfee-amount":    "The new fee increment valued in payt",
	...
	"getunconfirmedbalance--result0":  "Total amount of all unmined unspent outputs of the account valued in payt.",
