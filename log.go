...
var (
	...
	backendLog = paytlog.NewBackend(logWriter{})
	...
	paytnLog    = backendLog.Logger("paytN")
)
...
var subsystemLoggers = map[string]paytlog.Logger{
	"paytW": log,
	"WLLT":   walletLog,
	"TMGR":   txmgrLog,
	"CHNS":   chainLog,
...
func setLogLevel(subsystemID string, logLevel string) {
	...
	level, _ := paytlog.LevelFromString(logLevel)
