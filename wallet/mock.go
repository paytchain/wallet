...
func (m *mockChainClient) Rescan(*chainhash.Hash, []paytutil.Address,
	map[wire.OutPoint]paytutil.Address) error {
	return nil
}

func (m *mockChainClient) NotifyReceived([]paytutil.Address) error {
	return nil
}
