...
type RescanJob struct {
	...
	OutPoints   map[wire.OutPoint]paytutil.Address
...
// rescan.
func (w *Wallet) Rescan(addrs []paytutil.Address, unspent []wtxmgr.Credit) error {
...
func (w *Wallet) rescanWithTarget(addrs []paytutil.Address,
	unspent []wtxmgr.Credit, startStamp *waddrmgr.BlockStamp) error {

	outpoints := make(map[wire.OutPoint]paytutil.Address, len(unspent))
