...
[![GoDoc](https://godoc.org/github.com/payt-dag/paytwallet/walletdb?status.png)]
(http://godoc.org/github.com/payt-dag/paytwallet/walletdb)
...
http://localhost:6060/pkg/github.com/payt-dag/paytwallet/walletdb

## Installation

```bash
$ go get github.com/payt-dag/paytwallet/walletdb
```

## Examples

* [Basic Usage Example]
  (http://godoc.org/github.com/payt-dag/paytwallet/walletdb#example-package--BasicUsage)
