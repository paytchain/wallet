...
func ExampleStore_Balance() {
	...
	// Insert a transaction which outputs 10 payt unmined and mark the output
	// as a credit.
	...
	// Output:
	// 1 payt, 0 payt, 0 payt
	// 1 payt, 1 payt, 0 payt
	// 1 payt, 1 payt, 1 payt
}
...
func ExampleStore_Rollback() {
	...
	err = walletdb.Update(db, func(tx walletdb.ReadWriteTx) error {
		...
		// Insert a transaction which outputs 10 payt in a block at height 100.
...
func Example_basicUsage() {
	...
	// Insert an unmined transaction that outputs 10 payt to a wallet address
	// at output 0.
	...
	// outputs.  Mark the second one (5 payt) as wallet change.
